...
void removeArmy(string winPlayer, Country &cAtkr, Country &cDfndr) 
{
	...
	cout << "\nNumber of Attacker Armies: " << cAtkr.getNumOfArmies();
	cout << "\nNumber of Defender Armies: " << cDfndr.getNumOfArmies() << endl;
}
...
{
	while(cAtkr -> getNumOfArmies() > 0 && cDfndr -> getNumOfArmies() > -1)
	{
